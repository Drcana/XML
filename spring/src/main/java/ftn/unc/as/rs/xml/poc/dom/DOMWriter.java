...
public class DOMWriter {
    ...
    void generateZahtevDOM() {
        ...
        naslovDokumenta.appendChild(document.createTextNode("З А Х Т Е В за приступ информацији од јавног значаја"));
        ...
        dokumentZahtev.appendChild(uvidUDokument);
        ...
        dokumentZahtev.appendChild(kopijaDokumenta);
        ...
        dostavljanjeKopijeDokumenta.setAttribute("check", "");
        dostavljanjeKopijeDokumenta.appendChild(document.createTextNode("достављање копије документа који садржи тражену информацију"));
