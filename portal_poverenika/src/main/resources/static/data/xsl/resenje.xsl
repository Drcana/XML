...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:xs="http://www.w3.org/2001/XMLSchema" version="2.0" xmlns:res="http://www.ftn.uns.ac.rs/resenje"
    ...
    <xsl:template match="/">
        ...
        <body class="center">
            <p class="margin_top_bottom_zero">Решење када је жалба основана – налаже се: <xsl:value-of
                    select="/res:resenje/res:informacije_o_resenju/res:vrsta_resenja"></xsl:value-of>
            </p>

            <p class="margin_top_bottom_zero">Бр.
                <xsl:value-of select="/res:resenje/res:informacije_o_resenju/res:broj_resenja"></xsl:value-of>
                <span class="right_align">Датум: <xsl:value-of
                        select="/res:resenje/res:informacije_o_resenju/res:datum_resenja">
                    </xsl:value-of> године.</span>
            </p>
            ...
            <p>
                ...
                коју је изјавио
                <xsl:value-of select="/res:resenje/res:informacije_o_resenju/res:podnosilac_zahteva/types:ime">
                </xsl:value-of>
                <xsl:value-of select="/res:resenje/res:informacije_o_resenju/res:podnosilac_zahteva/types:prezime">
                </xsl:value-of>
                , због непоступања
                <xsl:value-of select="/res:resenje/res:informacije_o_resenju/res:organ/types:naziv_organa">
                </xsl:value-of>
                y
                <xsl:value-of select="/res:resenje/res:informacije_o_resenju/res:organ/types:adresa/types:mesto">
                </xsl:value-of>
                <xsl:value-of select="/res:resenje/res:informacije_o_resenju/res:organ/types:adresa/types:ulica">
                </xsl:value-of>
                <types:broj property="pred:broj_adrese_organa_vlasti" datatype="xs:string"/>
                    <xsl:value-of select="/res:resenje/res:informacije_o_resenju/res:organ/types:adresa/types:broj">
                    </xsl:value-of>
                    , по његовом захтеву од
                    <xsl:value-of select="/res:resenje/res:informacije_o_resenju/res:datum_podnosenja_zahteva">
                    </xsl:value-of>
                    године за приступ
            ...
            <p class="center_text">Р Е Ш Е Њ Е</p>

            <p class="indented margin_top_bottom_zero">I Налаже се Учитељском факултету у Призрену са привременим
                седиштем у
                Лепосавићу, да
                без одлагања, а најкасније у року од пет дана од дана пријема овог решења, обавести АА, да
                ли
                поседује тражене информације односно документ у коме су исте садржане, и то: Уговор о раду
                који
                је као последњи потписан између тог Факултета и ББ, те да му, уколико такав документ
                поседује
                достави копију истог електронском поштом на адресу … или поштом, с тим што ће пре достављања
                заштитити и учинити недоступним податке о личности којима би се повредило право на
                приватност
                лица на које се информације односе, као што су: адреса становања, лични матични број
                грађана,
                име
                оца, радни стаж, просечна оцена студирања и сл. уколико су такви подаци садржани у траженом
                документу.
            </p>
            <p class="indented margin_top_bottom_zero">
            ...
            <p class="center_text margin_bottom_zero">Образложење</p>
            <p class="indented margin_top_bottom_zero">
            ...
            <p class="indented margin_top_bottom_zero">
                ...
                изјасни о наводима жалбе, посебно о разлозима непоступања у законском року по поднетом
                захтеву
                у складу са одредбама члана 16. ст.1-9. или ст. 10. Закона, остављајући рок од осам дана,
                поводом
            ...
            <p class="indented margin_top_bottom_zero">
                ...
                орган власти није поступио, што је био дужан да учини без одлагања, а најкасније у року од
                15
                дана
                од пријема захтева те да жалиоца, у смислу члана 16. став 1. Закона о слободном приступу
                информацијама
                од јавног значаја, обавести да ли поседује тражене информације и да му, уколико
                исте поседује, стави на увид документ који исте садржи односно изда му или достави копију
                документа у коме су тражене информације садржане, или да у супротном донесе решење о
                одбијању
            ...
            <p class="indented margin_top_bottom_zero">
                ...
                да није оправдао разлоге непоступања по поднетом захтеву, Повереник је у поступку по жалби,
                на
                основу члана 23. и члана 24. ст. 1. и 4. Закона о слободном приступу информацијама од јавног
                значаја и члана 173. ст. 2. Закона о општем управном поступку, одлучио као у ставу I
                диспозитива
                овог решења, нашавши да је жалба основана, односно да је неспорно право жалиоца на тражене
                информације у смислу члана 5. Закона о слободном приступу информацијама од јавног значаја,
                по
                коме свако има право да му буде саопштено да ли орган власти поседује или му је доступна
                одређена
                информација од јавног значаја, као и да му се информација, уколико је у поседу органа, учини
                доступном, на начин како је то наложено у ставу I диспозитива овог решења, што је у складу
                са
                одредбом члана 12. Закона о слободном приступу информацијама од јавног значаја, која
                предвиђа
            ...
            <p class="indented margin_top_bottom_zero">
                ...
                извршењу решења из става I диспозитива, обавести Повереника у складу са чланом 24. став 3.
                Закона
            ...
            <div class="right_align">
                <p class="margin_top_bottom_zero">ПОВЕРЕНИК</p>
                <p class="margin_top_bottom_zero">
                    <xsl:value-of select="/res:resenje/res:poverenik/types:ime"></xsl:value-of>
                    <xsl:value-of select="/res:resenje/res:poverenik/types:prezime"></xsl:value-of>
                </p>
            </div>
        </body>
